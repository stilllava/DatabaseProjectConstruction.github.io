...
public class WindowManagerInformationUpdateStudentAdd {
    ...
    public WindowManagerInformationUpdateStudentAdd() {
        frame1.setTitle("教务管理系统管理员界面-信息维护功能-学生信息更新-添加学生信息");
    ...
    public static void main(String[] args) {
        new WindowManagerInformationUpdateStudentAdd();
    }
